...
//
// Shim.swift — @_silgen_name declarations for all AURA C FFI functions.
...
internal struct NativeAuraBuffer {
    var data: UnsafeMutablePointer<UInt8>?
    var length: Int
}

internal struct NativeAuraError {
    var code: UInt32
    var message: UnsafeMutablePointer<CChar>?
}

internal struct NativeAuraSessionConfig {
    var max_messages_per_chain: UInt32
}

internal struct NativeAuraGroupSecurityPolicy {
...
internal struct NativeAuraGroupDecryptResult {
    var plaintext: NativeAuraBuffer
    var sender_leaf_index: UInt32
    var generation: UInt32
    var content_type: UInt32
    var ttl_seconds: UInt32
    var sent_timestamp: UInt64
    var message_id: NativeAuraBuffer
    var referenced_message_id: NativeAuraBuffer
    var has_sealed_payload: UInt8
    var has_franking_data: UInt8
    var sealed_hint: NativeAuraBuffer
    var sealed_encrypted_content: NativeAuraBuffer
    var sealed_nonce: NativeAuraBuffer
    var sealed_key: NativeAuraBuffer
    var franking_tag: NativeAuraBuffer
    var franking_key: NativeAuraBuffer
    var franking_content: NativeAuraBuffer
    var franking_sealed_content: NativeAuraBuffer
}

internal struct NativeAuraSessionPeerIdentity {
    var ed25519_public: (
...
internal struct NativeAuraEnvelopeMetadata {
...
internal let AURA_SUCCESS: UInt32 = 0
internal let AURA_ERROR_GENERIC: UInt32 = 1
internal let AURA_ERROR_INVALID_INPUT: UInt32 = 2
internal let AURA_ERROR_KEY_GENERATION: UInt32 = 3
internal let AURA_ERROR_DERIVE_KEY: UInt32 = 4
internal let AURA_ERROR_HANDSHAKE: UInt32 = 5
internal let AURA_ERROR_ENCRYPTION: UInt32 = 6
internal let AURA_ERROR_DECRYPTION: UInt32 = 7
internal let AURA_ERROR_DECODE: UInt32 = 8
internal let AURA_ERROR_ENCODE: UInt32 = 9
internal let AURA_ERROR_BUFFER_TOO_SMALL: UInt32 = 10
internal let AURA_ERROR_OBJECT_DISPOSED: UInt32 = 11
internal let AURA_ERROR_PREPARE_LOCAL: UInt32 = 12
internal let AURA_ERROR_OUT_OF_MEMORY: UInt32 = 13
internal let AURA_ERROR_CRYPTO_FAILURE: UInt32 = 14
internal let AURA_ERROR_NULL_POINTER: UInt32 = 15
internal let AURA_ERROR_INVALID_STATE: UInt32 = 16
internal let AURA_ERROR_REPLAY_ATTACK: UInt32 = 17
internal let AURA_ERROR_SESSION_EXPIRED: UInt32 = 18
internal let AURA_ERROR_PQ_MISSING: UInt32 = 19
internal let AURA_ERROR_GROUP_PROTOCOL: UInt32 = 20
internal let AURA_ERROR_GROUP_MEMBERSHIP: UInt32 = 21
internal let AURA_ERROR_TREE_INTEGRITY: UInt32 = 22
internal let AURA_ERROR_WELCOME: UInt32 = 23
internal let AURA_ERROR_MESSAGE_EXPIRED: UInt32 = 24
internal let AURA_ERROR_FRANKING: UInt32 = 25
internal let AURA_ERROR_VOIP_CALL: UInt32 = 26
internal let AURA_ERROR_VOIP_MEDIA: UInt32 = 27
internal let AURA_ERROR_VOIP_REKEY: UInt32 = 28
internal let AURA_ERROR_BUSY: UInt32 = 29

// MARK: - Envelope type constants

internal let AURA_ENVELOPE_REQUEST: UInt32 = 0
internal let AURA_ENVELOPE_RESPONSE: UInt32 = 1
internal let AURA_ENVELOPE_NOTIFICATION: UInt32 = 2
internal let AURA_ENVELOPE_HEARTBEAT: UInt32 = 3
internal let AURA_ENVELOPE_ERROR_RESPONSE: UInt32 = 4
...
@_silgen_name("aura_shutdown")
internal func native_epp_shutdown()

// MARK: - Identity

@_silgen_name("aura_identity_create")
...
@_silgen_name("aura_identity_create_from_seed")
...
@_silgen_name("aura_identity_create_with_context")
...
@_silgen_name("aura_time_provider_manual_create")
...
@_silgen_name("aura_time_provider_manual_set_now_unix")
...
@_silgen_name("aura_identity_set_time_provider")
...
@_silgen_name("aura_identity_get_x25519_public")
...
@_silgen_name("aura_identity_get_ed25519_public")
...
@_silgen_name("aura_identity_get_kyber_public")
...
@_silgen_name("aura_prekey_bundle_create")
internal func native_epp_prekey_bundle_create(
    _ identity_handle: UnsafeMutableRawPointer?,
    _ out_bundle: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_prekey_bundle_replenish")
internal func native_epp_prekey_bundle_replenish(
    _ identity_handle: UnsafeMutableRawPointer?,
    _ count: UInt32,
    _ out_keys: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

// MARK: - Handshake initiator

@_silgen_name("aura_handshake_initiator_start")
internal func native_epp_handshake_initiator_start(
    ...
    _ config: UnsafePointer<NativeAuraSessionConfig>?,
    _ out_handle: UnsafeMutablePointer<UnsafeMutableRawPointer?>?,
    _ out_handshake_init: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_handshake_initiator_finish")
...
@_silgen_name("aura_handshake_initiator_destroy")
...
@_silgen_name("aura_handshake_responder_start")
internal func native_epp_handshake_responder_start(
    ...
    _ config: UnsafePointer<NativeAuraSessionConfig>?,
    _ out_handle: UnsafeMutablePointer<UnsafeMutableRawPointer?>?,
    _ out_handshake_ack: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_handshake_responder_finish")
...
@_silgen_name("aura_handshake_responder_destroy")
...
@_silgen_name("aura_session_encrypt")
internal func native_epp_session_encrypt(
    ...
    _ out_encrypted: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_session_decrypt")
internal func native_epp_session_decrypt(
    _ handle: UnsafeMutableRawPointer?,
    _ encrypted: UnsafePointer<UInt8>?,
    _ encrypted_length: Int,
    _ out_plaintext: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_metadata: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_envelope_metadata_parse")
internal func native_epp_envelope_metadata_parse(
    _ metadata_bytes: UnsafePointer<UInt8>?,
    _ metadata_length: Int,
    _ out_meta: UnsafeMutablePointer<NativeAuraEnvelopeMetadata>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_envelope_metadata_free")
internal func native_epp_envelope_metadata_free(
    _ meta: UnsafeMutablePointer<NativeAuraEnvelopeMetadata>?
)

@_silgen_name("aura_session_serialize_sealed")
internal func native_epp_session_serialize_sealed(
    _ handle: UnsafeMutableRawPointer?,
    _ key: UnsafePointer<UInt8>?,
    _ key_length: Int,
    _ external_counter: UInt64,
    _ out_state: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_session_deserialize_sealed")
...
@_silgen_name("aura_session_deserialize_sealed_with_time_provider")
...
@_silgen_name("aura_session_serialize_sealed_with_tracker")
...
@_silgen_name("aura_session_deserialize_sealed_with_tracker")
...
@_silgen_name("aura_session_deserialize_sealed_with_tracker_and_time_provider")
...
@_silgen_name("aura_session_export_persisted_state")
...
@_silgen_name("aura_session_restore_persisted_state")
...
@_silgen_name("aura_session_restore_persisted_state_with_time_provider")
...
@_silgen_name("aura_session_nonce_remaining")
...
@_silgen_name("aura_session_get_id")
internal func native_epp_session_get_id(
    _ handle: UnsafeMutableRawPointer?,
    _ out_session_id: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_session_get_identity_binding_hash")
internal func native_epp_session_get_identity_binding_hash(
    _ handle: UnsafeMutableRawPointer?,
    _ out_binding_hash: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_session_get_peer_identity")
internal func native_epp_session_get_peer_identity(
    _ handle: UnsafeMutableRawPointer?,
    _ out_identity: UnsafeMutablePointer<NativeAuraSessionPeerIdentity>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_session_get_local_identity")
...
@_silgen_name("aura_session_destroy")
...
@_silgen_name("aura_envelope_validate")
...
@_silgen_name("aura_derive_root_key")
...
@_silgen_name("aura_shamir_split")
internal func native_epp_shamir_split(
    ...
    _ out_shares: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_share_length: UnsafeMutablePointer<Int>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_shamir_reconstruct")
internal func native_epp_shamir_reconstruct(
    ...
    _ auth_key: UnsafePointer<UInt8>?,
    _ auth_key_length: Int,
    _ out_secret: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_secure_wipe")
...
@_silgen_name("aura_buffer_release")
internal func native_epp_buffer_release(
    _ buffer: UnsafeMutablePointer<NativeAuraBuffer>?
)

@_silgen_name("aura_buffer_alloc")
internal func native_epp_buffer_alloc(
    _ capacity: Int
) -> UnsafeMutablePointer<NativeAuraBuffer>?

@_silgen_name("aura_buffer_free")
internal func native_epp_buffer_free(
    _ buffer: UnsafeMutablePointer<NativeAuraBuffer>?
)

@_silgen_name("aura_error_free")
internal func native_epp_error_free(
    _ error: UnsafeMutablePointer<NativeAuraError>?
)

@_silgen_name("aura_error_string")
...
@_silgen_name("aura_sealed_state_counter_tracker_create")
internal func native_epp_sealed_state_counter_tracker_create(
    _ outHandle: UnsafeMutablePointer<UnsafeMutableRawPointer?>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_sealed_state_counter_tracker_create_from_serialized")
...
@_silgen_name("aura_sealed_state_counter_tracker_serialize")
internal func native_epp_sealed_state_counter_tracker_serialize(
    _ handle: UnsafeMutableRawPointer?,
    _ outState: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_sealed_state_counter_tracker_get_max_restored_counter")
...
@_silgen_name("aura_sealed_state_counter_tracker_get_latest_issued_counter")
...
@_silgen_name("aura_sealed_state_slot_serialize")
...
@_silgen_name("aura_sealed_state_slot_get_max_restored_counter")
...
@_silgen_name("aura_sealed_state_slot_get_latest_issued_counter")
...
@_silgen_name("aura_sealed_state_slot_destroy")
...
@_silgen_name("aura_group_create")
...
@_silgen_name("aura_group_create_shielded")
...
@_silgen_name("aura_group_create_with_policy")
internal func native_epp_group_create_with_policy(
    _ identity_handle: UnsafeMutableRawPointer?,
    _ credential: UnsafePointer<UInt8>?,
    _ credential_length: Int,
    _ policy: UnsafePointer<NativeAuraGroupSecurityPolicy>?,
    _ out_handle: UnsafeMutablePointer<UnsafeMutableRawPointer?>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_group_is_shielded")
...
internal func native_epp_group_get_security_policy(
    _ handle: UnsafeMutableRawPointer?,
    _ out_policy: UnsafeMutablePointer<NativeAuraGroupSecurityPolicy>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_group_join")
...
@_silgen_name("aura_group_authorize_external_join")
internal func native_epp_group_authorize_external_join(
    ...
    _ out_authorization: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_group_join_external")
internal func native_epp_group_join_external(
    ...
    _ credential_length: Int,
    _ out_group_handle: UnsafeMutablePointer<UnsafeMutableRawPointer?>?,
    _ out_commit: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

// MARK: - Group: membership

@_silgen_name("aura_group_add_member")
internal func native_epp_group_add_member(
    _ handle: UnsafeMutableRawPointer?,
    _ key_package: UnsafePointer<UInt8>?,
    _ key_package_length: Int,
    _ out_commit: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_welcome: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_group_remove_member")
...
@_silgen_name("aura_group_update")
...
@_silgen_name("aura_group_process_commit")
...
@_silgen_name("aura_group_encrypt")
...
@_silgen_name("aura_group_decrypt")
...
@_silgen_name("aura_group_encrypt_sealed")
...
@_silgen_name("aura_group_encrypt_disappearing")
...
@_silgen_name("aura_group_encrypt_edit")
...
@_silgen_name("aura_group_encrypt_delete")
...
@_silgen_name("aura_group_decrypt_result_free")
internal func native_epp_group_decrypt_result_free(
    _ result: UnsafeMutablePointer<NativeAuraGroupDecryptResult>?
)

// MARK: - Group: state queries

@_silgen_name("aura_group_get_id")
internal func native_epp_group_get_id(
    _ handle: UnsafeMutableRawPointer?,
    _ out_group_id: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_group_get_epoch")
internal func native_epp_group_get_epoch(
    _ handle: UnsafeMutableRawPointer?
) -> UInt64

@_silgen_name("aura_group_get_my_leaf_index")
internal func native_epp_group_get_my_leaf_index(
    _ handle: UnsafeMutableRawPointer?
) -> UInt32

@_silgen_name("aura_group_get_member_count")
internal func native_epp_group_get_member_count(
    _ handle: UnsafeMutableRawPointer?
) -> UInt32

@_silgen_name("aura_group_get_member_leaf_indices")
internal func native_epp_group_get_member_leaf_indices(
    _ handle: UnsafeMutableRawPointer?,
    _ out_indices: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

// MARK: - Group: serialization

@_silgen_name("aura_group_serialize")
...
@_silgen_name("aura_group_deserialize")
...
@_silgen_name("aura_group_serialize_with_tracker")
...
@_silgen_name("aura_group_deserialize_with_tracker")
...
@_silgen_name("aura_group_export_persisted_state")
...
@_silgen_name("aura_group_restore_persisted_state")
...
@_silgen_name("aura_group_export_public_state")
internal func native_epp_group_export_public_state(
    _ handle: UnsafeMutableRawPointer?,
    _ out_public_state: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

// MARK: - Group: crypto verification

@_silgen_name("aura_group_compute_message_id")
internal func native_epp_group_compute_message_id(
    ...
    _ generation: UInt32,
    _ out_message_id: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_group_reveal_sealed")
...
@_silgen_name("aura_group_verify_franking")
...
@_silgen_name("aura_group_set_psk")
...
@_silgen_name("aura_group_get_pending_reinit")
internal func native_epp_group_get_pending_reinit(
    _ handle: UnsafeMutableRawPointer?,
    _ out_new_group_id: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ out_new_version: UnsafeMutablePointer<UInt32>?,
    _ out_error: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_group_destroy")
...
/// Reads data from a NativeAuraBuffer and returns it as Data. Does NOT release the buffer.
internal func dataFromBuffer(_ buffer: NativeAuraBuffer) -> Data? {
...
internal struct NativeAuraEncryptedFrame {
    var call_id: NativeAuraBuffer
    var ssrc: UInt32
    var frame_counter: UInt64
    var ratchet_generation: UInt32
    var encrypted_payload: NativeAuraBuffer
    var nonce: NativeAuraBuffer
    var encrypted_header: NativeAuraBuffer
}

internal struct NativeAuraDecryptedFrame {
    var payload: NativeAuraBuffer
...
internal struct NativeAuraCallStatistics {
...
@_silgen_name("aura_voip_accept_call")
internal func native_epp_voip_accept_call(
    ...
    _ outAcceptBytes: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outSession: UnsafeMutablePointer<UnsafeMutableRawPointer?>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_call_init_start")
internal func native_epp_voip_call_init_start(
    ...
    _ outInitBytes: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outInitiator: UnsafeMutablePointer<UnsafeMutableRawPointer?>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_call_init_complete")
...
@_silgen_name("aura_voip_call_initiator_destroy")
internal func native_epp_voip_call_initiator_destroy(
    _ handle_ptr: UnsafeMutablePointer<UnsafeMutableRawPointer?>?
)

@_silgen_name("aura_voip_encrypt_frame")
internal func native_epp_voip_encrypt_frame(
    ...
    _ payloadLen: Int,
    _ outFrame: UnsafeMutablePointer<NativeAuraEncryptedFrame>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_decrypt_frame")
internal func native_epp_voip_decrypt_frame(
    ...
    _ outFrame: UnsafeMutablePointer<NativeAuraDecryptedFrame>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_call_id")
internal func native_epp_voip_call_id(
    _ handle: UnsafeRawPointer?,
    _ outBuf: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_ssrc")
internal func native_epp_voip_ssrc(
    _ handle: UnsafeRawPointer?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_is_shield_mode")
internal func native_epp_voip_is_shield_mode(
    _ handle: UnsafeRawPointer?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt8

@_silgen_name("aura_voip_end_call")
internal func native_epp_voip_end_call(
    _ handle: UnsafeRawPointer?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_generate_call_end_hmac")
internal func native_epp_voip_generate_call_end_hmac(
    _ handle: UnsafeRawPointer?,
    _ deviceId: UnsafePointer<UInt8>?,
    _ deviceIdLen: Int,
    _ timestamp: UInt64,
    _ outHmac: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_verify_call_end_hmac")
...
@_silgen_name("aura_voip_build_call_end")
...
@_silgen_name("aura_voip_process_call_end")
...
@_silgen_name("aura_voip_encrypt_call_control")
...
@_silgen_name("aura_voip_export_sealed_state")
...
@_silgen_name("aura_voip_export_sealed_state_with_tracker")
...
@_silgen_name("aura_voip_export_persisted_state")
...
@_silgen_name("aura_voip_initiate_rekey")
internal func native_epp_voip_initiate_rekey(
    _ handle: UnsafeRawPointer?,
    _ identity: UnsafeRawPointer?,
    _ peerKyberPublic: UnsafePointer<UInt8>?,
    _ peerKyberPublicLen: Int,
    _ outRekeyBytes: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_process_rekey")
internal func native_epp_voip_process_rekey(
    ...
    _ peerKyberPublic: UnsafePointer<UInt8>?,
    _ peerKyberPublicLen: Int,
    _ outAckBytes: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_process_rekey_ack")
...
@_silgen_name("aura_voip_import_sealed_state")
...
@_silgen_name("aura_voip_import_sealed_state_with_time_provider")
...
@_silgen_name("aura_voip_import_sealed_state_with_tracker")
...
@_silgen_name("aura_voip_import_sealed_state_with_tracker_and_time_provider")
...
@_silgen_name("aura_voip_restore_persisted_state")
...
@_silgen_name("aura_voip_restore_persisted_state_with_time_provider")
...
@_silgen_name("aura_voip_sealed_state_external_counter")
...
@_silgen_name("aura_voip_session_destroy")
internal func native_epp_voip_session_destroy(
    _ handle_ptr: UnsafeMutablePointer<UnsafeMutableRawPointer?>?
)

@_silgen_name("aura_voip_set_screen_share_meta")
...
@_silgen_name("aura_voip_get_screen_share_meta")
internal func native_epp_voip_get_screen_share_meta(
    ...
    _ outCodecHint: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_clear_screen_share_meta")
internal func native_epp_voip_clear_screen_share_meta(
    _ handle: UnsafeRawPointer?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_get_call_statistics")
internal func native_epp_voip_get_call_statistics(
    _ handle: UnsafeRawPointer?,
    _ outStats: UnsafeMutablePointer<NativeAuraCallStatistics>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_set_recording_consent")
...
@_silgen_name("aura_voip_get_local_recording_consent")
internal func native_epp_voip_get_local_recording_consent(
    _ handle: UnsafeRawPointer?
) -> Int32

@_silgen_name("aura_voip_get_remote_recording_consent")
internal func native_epp_voip_get_remote_recording_consent(
    _ handle: UnsafeRawPointer?
) -> Int32

@_silgen_name("aura_voip_both_consented_to_recording")
internal func native_epp_voip_both_consented_to_recording(
    _ handle: UnsafeRawPointer?
) -> Bool

@_silgen_name("aura_voip_build_recording_consent_message")
internal func native_epp_voip_build_recording_consent_message(
    _ handle: UnsafeRawPointer?,
    _ identity: UnsafeRawPointer?,
    _ consent: Int32,
    _ timestampUnix: UInt64,
    _ outMessage: UnsafeMutablePointer<NativeAuraBuffer>?,
    _ outError: UnsafeMutablePointer<NativeAuraError>?
) -> UInt32

@_silgen_name("aura_voip_process_recording_consent_message")
...
internal func checkResult(_ code: UInt32, _ nativeError: inout NativeAuraError) throws {
    guard code == AURA_SUCCESS else {
        let error = AuraError.from(code: code, nativeError: nativeError)
...
@_silgen_name("aura_attachment_generate_id")
internal func native_epp_attachment_generate_id(
    _ out_attachment_id: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_generate_file_key")
internal func native_epp_attachment_generate_file_key(
    _ out_file_key: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_encrypt_chunk")
internal func native_epp_attachment_encrypt_chunk(
    ...
    _ plaintext: UnsafePointer<UInt8>,
    _ plaintext_length: Int,
    _ out_nonce: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_ciphertext: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_decrypt_chunk")
...
@_silgen_name("aura_attachment_manifest_create")
internal func native_epp_attachment_manifest_create(
    ...
    _ out_manifest: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_manifest_validate")
...
@_silgen_name("aura_attachment_chunk_validate")
...
@_silgen_name("aura_attachment_encrypt_thumbnail")
...
@_silgen_name("aura_attachment_decrypt_thumbnail")
...
@_silgen_name("aura_attachment_validate_ttl")
internal func native_epp_attachment_validate_ttl(
    _ ttl_seconds: UInt64,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_is_expired")
...
@_silgen_name("aura_attachment_progress_create")
internal func native_epp_attachment_progress_create(
    _ attachment_id: UnsafePointer<UInt8>,
    _ attachment_id_length: Int,
    _ chunk_count: UInt32,
    _ out_progress: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_progress_mark_completed")
internal func native_epp_attachment_progress_mark_completed(
    ...
    _ now_unix: UInt64,
    _ out_updated_progress: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_progress_get_remaining")
internal func native_epp_attachment_progress_get_remaining(
    _ progress_bytes: UnsafePointer<UInt8>,
    _ progress_length: Int,
    _ out_remaining: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_remaining_count: UnsafeMutablePointer<UInt32>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_progress_is_complete")
internal func native_epp_attachment_progress_is_complete(
    _ progress_bytes: UnsafePointer<UInt8>,
    _ progress_length: Int
) -> Bool

@_silgen_name("aura_attachment_generate_collage_id")
internal func native_epp_attachment_generate_collage_id(
    _ out_collage_id: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_collage_create")
internal func native_epp_attachment_collage_create(
    ...
    _ out_collage: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_collage_validate")
...
@_silgen_name("aura_attachment_streaming_encryptor_create")
...
@_silgen_name("aura_attachment_streaming_encryptor_write")
internal func native_epp_attachment_streaming_encryptor_write(
    _ handle: UnsafeMutableRawPointer,
    _ data: UnsafePointer<UInt8>,
    _ data_length: Int,
    _ out_chunks: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_chunk_count: UnsafeMutablePointer<UInt32>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_streaming_encryptor_finish")
internal func native_epp_attachment_streaming_encryptor_finish(
    _ handle: UnsafeMutableRawPointer,
    _ out_chunk: UnsafeMutablePointer<NativeAuraBuffer>,
...
@_silgen_name("aura_attachment_streaming_decryptor_write")
...
@_silgen_name("aura_attachment_streaming_decryptor_is_complete")
...
@_silgen_name("aura_attachment_encrypt_file_key")
internal func native_epp_attachment_encrypt_file_key(
    ...
    _ attachment_id: UnsafePointer<UInt8>,
    _ attachment_id_length: Int,
    _ out_encrypted_file_key: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_decrypt_file_key")
...
@_silgen_name("aura_attachment_validate_magic_bytes")
...
@_silgen_name("aura_attachment_detect_mime")
internal func native_epp_attachment_detect_mime(
    _ header: UnsafePointer<UInt8>,
    _ header_length: Int,
    _ out_mime: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_validate_filename")
...
@_silgen_name("aura_attachment_sanitize_filename")
internal func native_epp_attachment_sanitize_filename(
    _ name: UnsafePointer<UInt8>,
    _ name_length: Int,
    _ out_sanitized: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_collage_create_with_metadata")
...
@_silgen_name("aura_attachment_inline_validate")
...
@_silgen_name("aura_attachment_inline_create")
internal func native_epp_attachment_inline_create(
    ...
    _ no_forward: UInt8,
    _ no_save: UInt8,
    _ out_buffer: UnsafeMutablePointer<NativeAuraBuffer>,
    _ out_error: UnsafeMutablePointer<NativeAuraError>
) -> UInt32

@_silgen_name("aura_attachment_reference_validate")
...
@_silgen_name("aura_attachment_reference_create")
...
@_silgen_name("aura_attachment_voice_meta_validate")
...
@_silgen_name("aura_attachment_voice_meta_create")
...
@_silgen_name("aura_attachment_location_validate")
...
@_silgen_name("aura_attachment_location_create")
...
@_silgen_name("aura_attachment_contact_card_validate")
...
@_silgen_name("aura_attachment_contact_card_create")
...
@_silgen_name("aura_attachment_link_preview_validate")
...
@_silgen_name("aura_attachment_link_preview_create")
