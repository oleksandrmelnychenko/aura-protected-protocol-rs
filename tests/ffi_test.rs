    ...
    unsafe {
        ...
        assert_eq!(
            aura_group_verify_franking(
                ...
                frankable_result.content_type,
                frankable_result.sealed_nonce.data,
                frankable_result.sealed_nonce.length,
                frankable_result.sealed_key.data,
                frankable_result.sealed_key.length,
                &mut franking_valid,
                &mut err,
            ),
            AuraErrorCode::AuraSuccess
