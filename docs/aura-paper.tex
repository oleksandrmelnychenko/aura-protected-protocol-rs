...
The remaining reproducibility work is external rather than conceptual: record an
independent review of the model/code alignment and publish release baselines for
the fixed benchmark profiles.
