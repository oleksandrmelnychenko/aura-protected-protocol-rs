...
handshake transcript, and the first post-handshake envelope under a test-only
deterministic entropy feature. The remaining reproducibility work is mechanical
rather than conceptual: add cross-ratchet envelope KATs without weakening
production entropy, publish one benchmark script with pinned tool versions, and
archive Tamarin/ProVerif outputs for a tagged release.
