...
test-only deterministic entropy feature. The remaining reproducibility work is
mechanical rather than conceptual: publish one benchmark script with pinned tool
versions, archive Tamarin/ProVerif outputs for a tagged release, and upload the
artifact logs from release CI.
