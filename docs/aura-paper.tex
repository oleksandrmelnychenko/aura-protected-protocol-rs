...
All benchmarks were conducted using Criterion.rs (v0.8, 200 samples, 5-second measurement time) on an Apple M-series processor. Results are summarized in \cref{tab:bench-core,tab:bench-payload,tab:bench-overhead}.
...
The remaining reproducibility work is mechanical rather than conceptual:
publish one benchmark script with pinned traffic-model profiles and record an
external review of the model/code alignment.
