...
a fresh hybrid ratchet step. This is stricter than Signal's DH-key-change
trigger: PCS recovery occurs at the first message after compromise, not
only after the first direction change.
\end{lemma}
