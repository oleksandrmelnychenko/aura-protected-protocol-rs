...
seeded ML-KEM public-key generation, and master-key identity derivation. The
remaining reproducibility work is mechanical rather than conceptual: add
deterministic full-handshake KATs, publish one benchmark script with pinned tool
versions, and archive Tamarin/ProVerif outputs for a tagged release.
