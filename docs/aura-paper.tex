...
seeded ML-KEM public-key generation, master-key identity derivation, and the
full handshake transcript under a test-only deterministic entropy feature. The
remaining reproducibility work is mechanical rather than conceptual: add
post-handshake envelope KATs without weakening production nonce generation,
publish one benchmark script with pinned tool versions, and archive
Tamarin/ProVerif outputs for a tagged release.
