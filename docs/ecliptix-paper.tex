...
\begin{itemize}
  \item Opaque handle types (\texttt{EppIdentityHandle}, \texttt{EppSessionHandle}, group/VoIP variants) with explicit create/destroy lifecycle.
  ...
  \item Uniform error reporting via \texttt{EppErrorCode} with human-readable error strings, including lifecycle and concurrency failures such as busy handles.
\end{itemize}
