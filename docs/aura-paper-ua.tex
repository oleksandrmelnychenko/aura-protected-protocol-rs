...
ProVerif. Реалізація мовою Rust містить близько 35{,}9~тис. рядків у
\texttt{src/}, 750~тестових сценаріїв у стандартній конфігурації та
...
Tamarin Prover and ProVerif, and a Rust implementation with 750/889 test
...
\begin{enumerate}
  ...
  \item[\textbf{Н5.}] \textbf{Комплексна формальна верифікація гібридного
    ...
    ProVerif (4 з 6 запитів, з аналізом причин апроксимації для
    двох незавершених запитів); \emph{(г)}~Rust-тести, benchmark-и
...
один публічний канал Долева--Яо і 10~символьних типів, а також
необмежену реплікацію сесій.
...
вразливостям протоколу. Q6 підтримано Tamarin-подібними моделями
секретності/PCS та ігровими доведеннями; Q5 підтримано ігровою
теоремою безпеки повідомлень і тестами реалізації. Отже, відсутність
...
У сукупності 14~з~16 запитів машинно перевірено, а
2~непідтверджені запити ProVerif розглядаються як задокументовані
обмеження інструмента, а не як машинно-доведені результати.
...
KEM у конструкції \Aura{} без наперед опублікованих ефемерних KEM-ключів,
а не дефектом. Ми припускаємо, що протокол із 1-кроковою гібридною PCS
...
вразливість, а артефакт інструмента. Q6 підтримано Tamarin-подібними
моделями секретності/PCS та ігровими доведеннями; Q5 підтримано
ігровою теоремою безпеки повідомлень і тестами реалізації.
...
композитною межею 128~біт класичної стійкості для типових розгортань.
У режимах AKE/HNDL без пізнішого розкриття відповідного KEM-секрету
Kyber-компонент дає 152~біти постквантової стійкості. Реалізація мовою Rust
(35{,}9~тис. рядків у \texttt{src/}, 750/889~тестових сценаріїв залежно
