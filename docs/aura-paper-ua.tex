...
5~с вимірювання) на процесорі Apple~M-series. Публічний benchmark-harness також
містить фіксовану групу \texttt{pq\_traffic\_profiles}: 128 повідомлень по
...
\midrule
Порівняння з SOTA & Є порівняння з \PQXDH{}, \SPQR{}, \PQThree{} та \MLS{} і фіксований benchmark-профіль для handshake-only, sparse-PQ, periodic-PQ та per-reply-PQ режимів & Додати релізні числові результати для кожного профілю і, за можливості, незалежно відтворені baselines. \\
Аналіз абляцій & Є журнал абляцій, негативні тести для пониження ratchet/KEM/metadata/sealed-state інваріантів і безпечний benchmark-профіль частоти KEM & Для окремого додатку можна опублікувати ізольовані insecure fork-профілі без додавання перемикачів пониження безпеки під час виконання у production-код. \\
Відтворюваність & Є artifact-entrypoint, фіксовані вектори, детерміновані KAT для handshake/envelope/cross-ratchet/multi-epoch, код, тести, proof-to-code таблиця, CI-пакет, формальні журнали, маніфест, SHA-256 контрольні суми, релізні benchmark-базові лінії та фіксовані профілі трафіку & Підтримувати release-tag артефакти для кожної версії статті. \\
Незалежна довіра & Є власні докази, машинні моделі та пакет для зовнішнього рецензування & Отримати зовнішнє рецензування моделі й коду; зафіксувати версії інструментів, хеші артефактів, зауваження і відповідь автора. \\
Межі застосування & Двосторонні теореми відділено від групових, VoIP, relay та binding-модулів; груповий код подано як окремий implementation context & Для групового профілю потрібні окрема TreeKEM-модель, proof-to-code map і аналіз конкурентності. \\
\bottomrule
\end{tabularx}
\end{table}
