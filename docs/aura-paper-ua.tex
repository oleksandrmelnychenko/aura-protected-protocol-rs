...
Відтворюваність & Є artifact-entrypoint, фіксовані вектори, детерміновані KAT для handshake/envelope/cross-ratchet/multi-epoch, код, тести, proof-to-code таблиця, CI-пакет, формальні журнали, маніфест, SHA-256 контрольні суми і fixed traffic-profile benchmarks & Зафіксувати release baselines для benchmark-профілів. \\
