...
опонента, що значно вище 80-бітового практичного мінімуму. У режимах
AKE/HNDL без пізнішого розкриття відповідного KEM-секрету
Kyber-компонент дає $182 - 30 = 152$~біти проти квантового опонента.
