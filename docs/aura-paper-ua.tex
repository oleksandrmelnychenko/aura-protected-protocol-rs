...
Відтворюваність & Є artifact-entrypoint, fixed vectors, deterministic handshake/envelope/cross-ratchet/multi-epoch KATs, код, тести і proof-to-code таблиця & Додати CI-артефакти для Tamarin/ProVerif і release-логи artifact-output. \\
