...
Порівняно з \SPQR{} та \PQThree{} внесок цієї роботи вужчий: відтворюваний
двосторонній Rust-артефакт з proof-to-code відповідністю, явним включенням
нового KEM-ключа до параметра $\mathit{info}$ HKDF та окремою ротацією ключа
метаданих.
...
Використовуємо AKE-модель у стилі Канетті--Кравчика~\cite{canetti2001} та
\eCK{}~\cite{lamacchia2007}, адаптовану до гібридного постквантового
сценарію. Конкретний набір оракулів і предикат свіжості задано нижче; тому
твердження слід читати саме відносно цієї leakage-моделі, а не як універсальну
заяву для всіх варіантів \eCK{} у літературі.
...
\begin{definition}[AKE-стійкість у \eCK{}-стилі]\label{def:ake}
...
\subsection{Теорема 2: AKE-стійкість у \eCK{}-стилі}\label{sec:thm2}

\begin{theorem}[AKE-стійкість у \eCK{}-стилі]\label{thm:ake}
...
Початковий KEM-компонент дає захист від harvest-now-decrypt-later лише доти,
доки відповідний KEM-секрет не розкрито; якщо пізніше розкрито і KEM-SK, і
приватний SPK респондента, а OPK у сесії не було, ця FS-межа не застосовується.
...
HNDL-захист без пізнішого розкриття KEM-секрету та PCS після появи свіжих
