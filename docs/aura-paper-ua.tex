...
handshake/envelope KATs і attack-PoC регресії; повні режими
...
і master-key identity derivation; deterministic handshake/envelope KATs
перевіряють байти \texttt{HandshakeInit}, \texttt{HandshakeAck}, session id
і перший post-handshake envelope під test-only entropy feature. \\
\addlinespace
...
Відтворюваність & Є artifact-entrypoint, fixed vectors, deterministic handshake/envelope KATs, код, тести і proof-to-code таблиця & Додати cross-ratchet envelope KATs і CI-артефакти для Tamarin/ProVerif. \\
