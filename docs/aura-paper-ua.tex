...
handshake transcript KAT і attack-PoC регресії; повні режими
...
і master-key identity derivation; deterministic handshake transcript KAT
перевіряє байти \texttt{HandshakeInit}, \texttt{HandshakeAck} та session id
під test-only entropy feature. \\
\addlinespace
...
Відтворюваність & Є artifact-entrypoint, fixed vectors, deterministic handshake transcript KAT, код, тести і proof-to-code таблиця & Додати post-handshake envelope KATs і CI-артефакти для Tamarin/ProVerif. \\
