...
\begin{enumerate}[nosep]
  \item In Signal, if Alice sends 100 messages then Bob replies, only Bob's
        reply triggers a ratchet.  In AURA, Bob's reply triggers a ratchet
...
\caption{Concrete security levels for AURA components and composite bounds.}
\label{tab:bounds}
\small
\begin{tabular}{@{}llr@{}}
\toprule
...
We have provided a comprehensive game-based security analysis of the Aura
